				...
				<div className="flex justify-between items-center h-16">
					...
					<div className="flex items-center space-x-4">
						...
						<Link to="/" className="flex items-center space-x-2">
							...
							<span className="text-xl font-bold text-mail-primary">Better Mailhunt</span>
						</Link>
					</div>
							...
							<div className="relative">
								...
								>
									{session.user.id && !photoError ? (
										...
										<div className="w-8 h-8 bg-mail-primary rounded-full flex items-center justify-center text-white font-semibold">
										...
										<div className="absolute right-0 mt-2 w-48 bg-white rounded-lg shadow-xl border border-mail-gray-200 z-20">
											<div className="py-1">
												...
												<Link
													to="/profile"
													onClick={() => setIsUserMenuOpen(false)}
													className="block w-full text-left px-4 py-2 text-sm text-mail-gray-700 hover:bg-mail-gray-50 transition-colors"
												>
													Profile Settings
												</Link>
												<button
